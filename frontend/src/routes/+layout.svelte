...
<div class="navbar bg-base-300">
	...
	<div class="navbar-center">
		<ul class="menu menu-horizontal">
			...
			<li>
				<a href="/" class="tooltip tooltip-bottom" data-tip="hoard"><Landmark /></a>
			</li>
			<li>
				<a href="/" class="tooltip tooltip-bottom" data-tip="leaderboard"><ListOrdered /></a>
			</li>
		</ul>
	</div>
...
<div class="flex h-[calc(100vh-72px)]">
	<div class="flex-1 h-full flex flex-col gap-4 justify-center items-center">
		<slot />
	</div>
	<ChatBox />
</div>
